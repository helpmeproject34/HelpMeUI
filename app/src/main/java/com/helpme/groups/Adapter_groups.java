...
public class Adapter_groups extends BaseAdapter {
	...
	public View getView(int index, View view, ViewGroup parent) {
		...
		TextView tv_large=(TextView)(view.findViewById(R.id.textview_layout_group_name));
		TextView tv_medium=(TextView)(view.findViewById(R.id.textview_layout_group_text));
